...
<div class="floatcontainer">
    ...
    {* Phone number and email forms *}
    <div class="left-half crm-section contact_information-section">
        <table class="crm-section contact_information-section"> 
        ...
        <div id="upload-image" class="form-item">
...
{foreach from = $editOptions item = "title" key="name"}
    {if $name == 'CustomData' }
        {include file="CRM/Contact/Form/Edit/$name.tpl"}
        <div id='customData'></div>  <!-- no idea what this empty div is for -->
    {/if}
{/foreach}
