...
{/if}
  ...
  {if $blockId gt 1}<fieldset><legend>{ts}Additional Address{/ts}</legend>{/if}
	 ...
	 {if $className eq 'CRM_Contact_Form_Contact'}
           <div class="form-item">
               ...
               {$form.address.$blockId.location_type_id.html} {if $blockId gt 0}
 ...
 {/if}    
  ...
  <div class="form-item left-half">
      {$form.address.$blockId.is_primary.html}
  </div>
  <div class="form-item right-half">
  ...
  <div class="form-item ">
     {$form.address.$blockId.use_shared_address.html}{$form.address.$blockId.use_shared_address.label}{help id="id-sharedAddress" file="CRM/Contact/Form/Contact.hlp"}<br />
         ...
         {/if}
         <table id="shared-address-{$blockId}" class="form-layout-compressed hiddenElement shared-address">
