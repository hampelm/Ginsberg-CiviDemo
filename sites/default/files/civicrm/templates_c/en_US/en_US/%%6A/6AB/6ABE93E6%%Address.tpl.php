...
" <?php if ($this->_tpl_vars['className'] == 'CRM_Contact_Form_Contact'): ?> class="boxBlock crm-edit-address-block" <?php endif; ?>>
  <?php if ($this->_tpl_vars['blockId'] > 1): ?><fieldset><legend>Additional Address</legend><?php endif; ?>
...
<?php echo smarty_function_help(array('id' => "id-usehousehold",'file' => "CRM/Contact/Form/Contact.hlp"), $this);?>
<br />
