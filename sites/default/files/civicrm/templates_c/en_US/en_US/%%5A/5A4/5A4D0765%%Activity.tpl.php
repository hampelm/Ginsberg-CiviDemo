<?php /* Smarty version 2.6.26, created on 2010-11-16 17:03:52
         compiled from CRM/Case/Form/Activity.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'crmURL', 'CRM/Case/Form/Activity.tpl', 56, false),array('function', 'cycle', 'CRM/Case/Form/Activity.tpl', 232, false),array('modifier', 'explode', 'CRM/Case/Form/Activity.tpl', 57, false),array('modifier', 'escape', 'CRM/Case/Form/Activity.tpl', 126, false),array('modifier', 'crmReplace', 'CRM/Case/Form/Activity.tpl', 189, false),array('block', 'ts', 'CRM/Case/Form/Activity.tpl', 85, false),array('block', 'edit', 'CRM/Case/Form/Activity.tpl', 173, false),)), $this); ?>
    ...
    <?php endif; ?>
        ...
        <table class="form-layout">
	       ...
	       <?php if (! $this->_tpl_vars['multiClient']): ?>
              ...
              <td class="view-value"><span class="font-size12pt"><?php echo ((is_array($_tmp=$this->_tpl_vars['client_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&nbsp;&nbsp;&nbsp;&nbsp;</span>
	       <?php else: ?>
...
?><?php echo '<tr class="'; ?><?php echo smarty_function_cycle(array('values' => "odd-row,even-row"), $this);?><?php echo '"><td class="crm-case-activity-form-block-contact_'; ?><?php echo $this->_tpl_vars['id']; ?><?php echo '">'; ?><?php echo $this->_tpl_vars['form']['contact_check'][$this->_tpl_vars['id']]['html']; ?><?php echo '</td><td class="crm-case-activity-form-block-role">'; ?><?php echo $this->_tpl_vars['row']['role']; ?><?php echo '</td><td class="crm-case-activity-form-block-display_name">'; ?><?php echo $this->_tpl_vars['row']['display_name']; ?><?php echo '</td><td class="crm-case-activity-form-block-email">'; ?><?php echo $this->_tpl_vars['row']['email']; ?><?php echo '</td></tr>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '</table>'; ?>
