<?php /* Smarty version 2.6.26, created on 2010-11-16 17:02:52
         compiled from CRM/Case/Form/CaseView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Case/Form/CaseView.tpl', 33, false),array('function', 'crmURL', 'CRM/Case/Form/CaseView.tpl', 55, false),array('function', 'crmKey', 'CRM/Case/Form/CaseView.tpl', 346, false),array('modifier', 'crmDate', 'CRM/Case/Form/CaseView.tpl', 81, false),array('modifier', 'crmReplace', 'CRM/Case/Form/CaseView.tpl', 143, false),array('modifier', 'count', 'CRM/Case/Form/CaseView.tpl', 224, false),)), $this); ?>
...
, <?php echo $this->_tpl_vars['contactID']; ?>
        ...
        <td class="crm-case-caseview-case_type label">
            <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Case Type<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>:&nbsp;<?php echo $this->_tpl_vars['caseDetails']['case_type']; ?>
...
"<?php echo ';
			   var errorMsg = \''; ?>
<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>The relationship type definition for the  <?php echo '\' + relTypeName + \''; ?>
...
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('crmURL', ob_get_contents());ob_end_clean(); ?>
  ...
  <?php if ($this->_tpl_vars['globalRelationships']): ?>
    <div><input type="button" class="form-submit default" onClick="window.location='<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/group/search','q' => "reset=1&context=amtg&amtgID=".($this->_tpl_vars['globalGroupInfo']['id'])), $this);?>
'" value="<?php $this->_tag_stack[] = array('ts', array('1' => $this->_tpl_vars['globalGroupInfo']['title'])); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Add members to %1<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" /></div>
