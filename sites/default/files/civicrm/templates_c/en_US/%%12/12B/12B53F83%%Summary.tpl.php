<?php /* Smarty version 2.6.26, created on 2011-01-27 14:51:11
         compiled from CRM/Contact/Page/View/Summary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'crmURL', 'CRM/Contact/Page/View/Summary.tpl', 44, false),array('function', 'cycle', 'CRM/Contact/Page/View/Summary.tpl', 265, false),array('block', 'ts', 'CRM/Contact/Page/View/Summary.tpl', 44, false),array('modifier', 'cat', 'CRM/Contact/Page/View/Summary.tpl', 76, false),array('modifier', 'nl2br', 'CRM/Contact/Page/View/Summary.tpl', 199, false),array('modifier', 'mb_truncate', 'CRM/Contact/Page/View/Summary.tpl', 246, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
                ...
                <div id="contactTopBar">
                    <?php if ($this->_tpl_vars['contact_type_label'] || $this->_tpl_vars['userRecordUrl'] || $this->_tpl_vars['current_employer_id'] || $this->_tpl_vars['job_title'] || $this->_tpl_vars['legal_name'] || $this->_tpl_vars['sic_code'] || $this->_tpl_vars['nick_name']): ?>
                    
                        <?php if ($this->_tpl_vars['current_employer_id']): ?>
                            <div class="jobtitle">
                            <?php if ($this->_tpl_vars['job_title']): ?><?php echo $this->_tpl_vars['job_title']; ?>
<?php endif; ?> at 
...
-->
                    ...
                    <?php if ($this->_tpl_vars['contactTag'] || $this->_tpl_vars['userRecordUrl'] || $this->_tpl_vars['source']): ?>
                    <tr>
                        <?php if ($this->_tpl_vars['contactTag']): ?>
...
"><?php echo $this->_tpl_vars['item']['email']; ?>
                                                ...
                                                <?php if ($this->_tpl_vars['item']['on_hold']): ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if ($this->_tpl_vars['item']['is_bulkmail']): ?>
...
?>
                                        <?php if ($this->_tpl_vars['item']['phone']): ?>
                                            <div <?php if ($this->_tpl_vars['item']['is_primary'] == 1): ?>class="primary"<?php endif; ?>>
                                                ...
                                                </span> (<?php echo $this->_tpl_vars['item']['location_type']; ?>
